...
const Register = () => {
    ...
    const handleRegister = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post('https://localhost:3000/register', { firstName, lastName, email, password, contactNumber });
        ...
        <>
            ...
            <div className={`flex min-h-full flex-1 flex-col justify-center px-6 py-[88px] lg:px-8 ${theme === "dark" ? "bg-gray-900 text-white" : "bg-white text-gray-900"}`} style={{ backgroundColor: "#AED2FF" }}>
                ...
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    <form className="spac-y-6" onSubmit={handleRegister}>
                        {/* First Name field */}
                        <div>
                            <label htmlFor="firstNamee" className="block text-sm font-medium leading-6">
                                First Name
                            </label>
                            <div className="mt-2">
                                <input
